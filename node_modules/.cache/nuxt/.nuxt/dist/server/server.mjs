...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, nextTick, unref, customRef, onScopeDispose, createVNode, Text, Fragment, defineAsyncComponent, Suspense, mergeProps, withCtx, useSSRContext, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/mac/Desktop/dhivals/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/mac/Desktop/dhivals/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/mac/Desktop/dhivals/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/Users/mac/Desktop/dhivals/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, createDefu } from "/Users/mac/Desktop/dhivals/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parsePath, parseQuery, withoutTrailingSlash, isEqual as isEqual$1 } from "/Users/mac/Desktop/dhivals/node_modules/ufo/dist/index.mjs";
import { debounce } from "/Users/mac/Desktop/dhivals/node_modules/perfect-debounce/dist/index.mjs";
import { hash, isEqual } from "/Users/mac/Desktop/dhivals/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import { klona } from "/Users/mac/Desktop/dhivals/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "/Users/mac/Desktop/dhivals/node_modules/cookie-es/dist/index.mjs";
import { getRequestURL as getRequestURL$1, getRequestHeader as getRequestHeader$1, getCookie as getCookie$1 } from "/Users/mac/Desktop/dhivals/node_modules/h3/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/mac/Desktop/dhivals/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index___fr",
    path: "/",
    component: () => import("./_nuxt/index-B1y1I0H0.js")
  },
  {
    name: "index___en",
    path: "/en",
...
const localeLoaders = {
  fr: [
    {
      key: "locale_fr_46json_26008ed8",
      load: () => import(
        "./_nuxt/fr-DhGD83Vt.js"
        /* webpackChunkName: "locale_fr_46json_26008ed8" */
      ),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_c7ca5b2e",
      load: () => import(
        "./_nuxt/en-CinTMusg.js"
        /* webpackChunkName: "locale_en_46json_c7ca5b2e" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { fr: "aeffdb0e", en: "aeffdb0e" };
...
var define_I18N_LOCALE_HASHES_default = { fr: "aeffdb0e", en: "aeffdb0e" };
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CR3kRsa9.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CQJTUZXD.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-63qMNmSz.js"));
